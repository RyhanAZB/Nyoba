...
def index_view(request):
    ...
    # Mendefinisikan nilai balik hasil request 
    # dari 'semua_data' ke 'datas' 
    # yang nanti akan digunakan pada index.html
    context = {
        'datas': semua_data
    }
    # memparsing data ke template mendata/index.html dan
    # merender nya
...
# Mengambil data berdasarkan ID
    try:
        # Mengambil data berdasarkan ID 
        # dari class "Data" pada models.py
    ...
    # parsing data ke template mendata/detail.html dan
    # merendernya
...
def create_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            new_data.save()
            # mengeset pesan sukses dan redirect ke 
            #halaman view table
...
def update_view(request, data_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.save()
            # mengeset pesan sukses dan redirect ke halaman
            # daftar table
    ...
    # merender template form dengan memparsing data form, agar
    # terbaca pada form.html
    return render(request, 'mendata/form.html', {'form': form})
 
# Membuat View untuk menghapus data
def delete_view(request, data_id):
    try:
        # mengambil data data_lama yang akan dihapus 
        # berdasarkan id
